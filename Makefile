...
#	TeX -> PDF erstellen
#======================================================================
$(MAIN).pdf: $(MAIN).tex $(OBJECTS) hyperref.cfg
	@echo '---------------------------------------------------'
...
clean:
	...
	@rm -f *.out
	@rm -f *.dvi
	@rm -f *.blg # bibtex files
	@rm -f *.bbl # bibtex files
	@rm -f *.idx # makeindex files
	@rm -f *.ind # makeindex files
	@rm -f $(MAIN).synctex.gz  # texstudio
...
help:
	...
	@echo -e 'make file     :  Erlaeuterung zu den Dateien\n'
	@echo '----------------------------------------------------------------'
...
file:
	...
	@echo 'Dateien'
	@echo -e '----------------------------------------------------------------\n'
	@echo -e 'Makefile - "make help" fuer Hilfe\n'
	...
	@echo 'user.dbj - Batchfile fuer user.bst'
	@echo 'user.bst - aktuelle Bib-Styles'
	@echo -e 'literatur.bib - Literaturdatenbank fuer Referenzen\n'
	@echo -e 'hyperref.cfg - Einstellungen fuer hyperref\n'
